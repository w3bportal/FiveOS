...
public partial class App : Application
{
    ...
    public const string DiscordInviteUrl = "https://discord.gg/twPjCCTnaU";
    ...
    protected override void OnStartup(StartupEventArgs e)
    {
        ...
        Action doFinish = () =>
        {
            ...
            // splash had the screen to itself): restore it to Maximized —
            // which snaps it onto a monitor — and hand focus to it as the
            // splash closes.
